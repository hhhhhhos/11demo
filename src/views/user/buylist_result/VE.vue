<template>
  <div>
    ...
    <div style="margin: 50px 100px;" class="myborder">
      ...
      <E2 style="text-align:left;margin-left:20px;margin-bottom:20px;" @address="address_change" @radio="radio=>radio_change(radio)"></E2>
    </div>
    <div style="margin: 50px 100px;" class="myborder">
    ...
    <el-dialog :title="this.dialog_title" :visible.sync="dialogVisible" width="20%" center>
      <div style="display: flex; justify-content: center; align-items: center;">
        <el-radio v-model="radio2" label="1">余额(剩余:{{ this.money }})</el-radio>
        <el-radio v-model="radio2" label="2">微信扫码</el-radio>
      </div>
...
export default {
  ...
  methods:{
    ...
    async final_pay(){
      ...
      // 1.创建历史订单信息 2.删除购物车
      if(this.build_historylist()&&await this.deletebyids()){
