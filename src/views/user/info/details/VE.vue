      ...
      <div v-loading="isloading1" class="myborder" style="padding: 10px; width: 90vw;margin: 8px auto 15px;">
        <div class="myhover" v-for="(data,index) in this.obj" :key="index" style="text-align: left;display: flex;">
          ...
          <div v-if="!isupdateinfo" style="margin: 5px 5px;display: flex;font-size: small;">
              ...
              <div v-else-if="index==='wechat_headimgurl'" style="display: flex;">
                <div style="width: 120px;display: flex;align-items: center;">{{ index }}</div><span style="display: flex;align-items: center;">:</span><img style="width:40px;margin:0 20px ;border-radius: 66px;" :src="data">
              </div>
