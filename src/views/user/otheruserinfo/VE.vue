        ...
        <div style="display: flex; flex-direction: column;width: 100%;">
          ...
          <div style="display: flex;justify-content: right;">
            <el-row style="width: 100%;max-width:400px;margin: 15px 30px 10px 10px;z-index: 1;">
              ...
              <el-col :span="8">
                <p @click="$router.push(`/user/fanorguanzhu?p1=fs&user_id=${user_id}`)"
                v-html="fs===-1?'<i class=\'el-icon-loading\'></i>':fs"></p>
                <span>粉丝</span>
              </el-col>
              <el-col :span="8">
                <p @click="$router.push(`/user/fanorguanzhu?p1=gz&user_id=${user_id}`)"
          ...
          <div style="display: flex;justify-content: right;">
            <el-button @click="addordeleteFan()" :loading="addordeleteFan_loading" size="small" :type="addordeleteFan_type" round style="z-index: 1;width:70px;margin: 15px 40px 0 0;">
              {{addordeleteFan_text}}
            </el-button>
          </div>
